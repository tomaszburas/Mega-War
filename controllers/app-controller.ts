...
import {User as UserInterface} from "../ts/interfaces/User.js"
...
export class AppController {
    ...
    static async profileHero(req: Request, res: Response) {
    ...
    static async configureWarrior(req: Request, res: Response) {
    ...
    static async arenaPlayer1(req: Request, res: Response) {
        const user = await User.findOne({_id: req.user.id})
    ...
    static async arenaPlayer2Username(req: Request, res: Response) {
    ...
    static async arenaPlayer2Random(req: Request, res: Response) {
        ...
        const usersFitToFight: UserInterface[] = [];
        users.forEach(user => {
    ...
    static async arena(req: Request, res: Response) {
